...
- rama principal: `main`;
- versión candidata: `2.9.0-beta.4`.
...
git branch -M main
git add .
git commit -m "Prepare Euskalmet 2.9.0-beta.4 for HACS"
...
```bash
git tag -a 2.9.0-beta.4 -m "Euskalmet 2.9.0-beta.4"
git push origin 2.9.0-beta.4
```
