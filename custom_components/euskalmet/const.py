...
DAY_SUMMARY_UPDATE_INTERVAL = timedelta(minutes=15)
ALERTS_UPDATE_INTERVAL = timedelta(minutes=15)
HOURLY_FORECAST_UPDATE_INTERVAL = timedelta(hours=1)
DAILY_FORECAST_UPDATE_INTERVAL = timedelta(hours=2)
OCEAN_FORECAST_UPDATE_INTERVAL = timedelta(hours=2)
TIDES_UPDATE_INTERVAL = timedelta(hours=6)
MONTH_SUMMARY_UPDATE_INTERVAL = timedelta(hours=1)
